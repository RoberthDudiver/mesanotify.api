...
namespace App.Api.Controllers
{
    ...
    {
        [HttpPost]
        [ProducesResponseType(typeof(CreateCallsCommand), StatusCodes.Status201Created)]
        [ProducesResponseType(typeof(List<Notify>), StatusCodes.Status400BadRequest)]
        public async Task<IActionResult> Create(CreateCallsCommand body) => Result(await Mediator.Send(body));
        [HttpPut]
